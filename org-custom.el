  ...
  (progn
    ...
    (setq org-global-properties
          '(("Effort_ALL". "1:00 2:00 3:00 4:00 5:00 6:00 7:00 8:00 9:00 0:30")
            ("COLUMNS". "%38ITEM %PRIORITY %DEADLINE %SCHEDULED %7Effort{:} %5CLOCKSUM")))
    ...
    (setq
     ...
     '(("g"        . "https://www.google.com/search?q=")
       ...
       ("gfin"     . "https://www.google.com/finance?q=")
       ("gmap"     . "https://maps.google.com/maps?q=")
       ("nsf"      . "https://www.nsf.gov/awardsearch/showAward.do?AwardNumber=")
       ("tw"       . "https://twitter.com/")
       ("d"        . "https://www.duckduckgo.com/?q=")
       ("sd"       . "https://slickdeals.net/newsearch.php?firstonly=1&q=")
       ("sg"       . "https://sourcegraph.com/search?q=")
       ("cb"       . "https://crunchbase.com/search?query=")
       ("usc"      . "https://www.law.cornell.edu/uscode/text/")
       ("cfr"      . "https://www.law.cornell.edu/cfr/text/")
       ("ontrack"  . "https://www.ontrac.com/trackres.asp?tracking_number=")
